    ...
    >
      <div className="flex items-start gap-2.5">
        ...
        <div className="text-sm text-[#2A2A2A]">
          <p className="font-medium mb-1">Simulação de encargos</p>
          <p className="text-mid">
            Para uma parcela de R${formatBRL(SAMPLE_AMOUNT)} vencida há {SAMPLE_DAYS_OVERDUE} dias
            {gracePeriodDays > 0 && ` (carência de ${gracePeriodDays} dias)`}:
          </p>
