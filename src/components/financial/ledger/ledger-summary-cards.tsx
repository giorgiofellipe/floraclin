...
export function LedgerSummaryCards({ summary }: { summary: LedgerSummary }) {
  ...
  return (
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
      ...
      <Card size="sm" className="rounded-[3px] bg-white shadow-[0_1px_4px_rgba(0,0,0,0.06)]">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-xs uppercase tracking-wider font-medium text-mid">Total Saídas</CardTitle>
      ...
      <Card size="sm" className="rounded-[3px] bg-white shadow-[0_1px_4px_rgba(0,0,0,0.06)]">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          <CardTitle className="text-xs uppercase tracking-wider font-medium text-mid">Resultado Líquido</CardTitle>
